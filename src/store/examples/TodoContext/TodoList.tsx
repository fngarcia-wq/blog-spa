/**
 * 📝 Componente de lista de TODOs usando Context API
 */
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h2 style={styles.title}>📋 TODO - Context API</h2>
        <div style={styles.badge}>Nativo de React</div>
      </div>
      ...
      <div style={styles.info}>
        <p style={styles.infoText}>
          💡 <strong>Context API:</strong> Simple y nativo, ideal para estados
          que cambian poco.
        </p>
        <p style={styles.infoText}>
          ⚠️ Todos los consumidores se re-renderizan cuando cambia cualquier
          valor.
        </p>
      </div>
    </div>
