        ...
        return (
          <div className="security-intro">
            ...
            <div className="golden-rule">
              ...
              <blockquote>
                "Nunca confíes en el frontend. Toda validación y seguridad debe existir también en el backend. 
                El frontend es solo la primera línea de defensa, no la única."
              </blockquote>
            </div>
            ...
            <div className="why-important">
              ...
              <ul>
                <li>🎯 <strong>Primera línea de defensa:</strong> El frontend es el punto de entrada visible para atacantes</li>
                <li>🔐 <strong>Datos sensibles:</strong> Maneja tokens, información personal y sesiones de usuario</li>
                <li>🌐 <strong>Superficie de ataque amplia:</strong> Múltiples vectores de ataque (XSS, CSRF, etc.)</li>
                <li>📱 <strong>Confianza del usuario:</strong> La seguridad afecta directamente la experiencia del usuario</li>
                <li>💰 <strong>Impacto en el negocio:</strong> Las brechas de seguridad pueden ser costosas</li>
              </ul>
            </div>
            ...
            <div className="security-principles">
              ...
              <div className="principles-grid">
                <div className="principle-card">
                  ...
                  <p>Múltiples capas de seguridad: frontend, backend, red, infraestructura</p>
                </div>
                <div className="principle-card">
